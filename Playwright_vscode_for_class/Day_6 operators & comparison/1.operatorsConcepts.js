...
function ticketingSystem(){
    ...
    while (ticket_again){
        ...
        fee = {
            1 : "age less than 5 FREE Entry",
            2 : "age between 5 to 11 cost $ 50",
            3 : "age between 12 to 29 cost $ 100",
            4 : "age 30 to 50 cost $ 75",
            5 : "age 51 and above not allowed",
        }
        console.log("Logics to be consider")
        for (value in fee){
...
function squidGame(){
    ...
    console.log("GAME 1")
    console.log("Guess and choose the safest room out of 3.")
    let money = 10
    ...
    if(q1=== "3"){
        ...
        if (q2==="function expression"){
            ...
            console.log("GAME 3")
            let q3 = prompt("Q3.result of '5'+ 1 in JS ")
            if (q3=="51"){
                money += 100
        ...
        if (choice1>0 && choice1<5) {
            ...
            if(playAgain === "y"){
                ...
                for(i=0;i<3;i++){
                    setTimeout(function(){
                    console.clear()
                    console.log("Shutting Down in",i--, "seconds...")
                    },i*1000)
                }
